...
export default function Hero() {
  return (
    <section className="relative">
      <div className="relative min-h-[78vh] overflow-hidden pb-24">
      {heroMedia.video ? (
        <video
          autoPlay
          muted
      ...
      <div className="relative mx-auto flex max-w-7xl flex-col justify-center px-6 pb-20 pt-32 lg:px-8 lg:pb-24 lg:pt-40">
      ...
      <div className="relative z-40 -mt-14 px-4 sm:-mt-16 sm:px-6 lg:px-8">
        <SearchBar />
      </div>
    </section>
  );
